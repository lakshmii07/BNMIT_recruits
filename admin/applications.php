							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-primary confirmation mt-1" type="button" data-id="<?php echo $row['id'] ?>" >Confirmation</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$(".confirmation").click(function(){
		uni_modal("","confirmation.php?id="+$(this).attr('data-id'),"mid-large")
	})
